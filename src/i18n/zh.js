const zhCN = {
  ...
  'admin.users.admin': '管理员列表',
  'admin.users.seller': '卖家列表',
  'admin.users.buyer': '买家列表',
  'admin.adspace': '广告位',
  'admin.adspace.list': '广告位列表',
  'admin.adspace.banner': '展示类广告位',
  'admin.ssp': '流量通路',
  'admin.ssp.banner': '展示类流量通路',
  'admin.reports': '报表',
  ...
  // List
  'users.seller': '卖家用户列表',
  'users.seller.list': '卖家列表',
  'users.seller.list.title': '用户列表',
  'users.seller.list.name': '名称',
  'users.seller.list.company': '公司',
  'users.seller.list.media_type': '卖家类型',
  'users.seller.list.account_role': '账户类型',
  'users.seller.list.create_time': '创建时间',
  'users.seller.list.action': '操作',
  'users.buyer': '买家用户列表',
  'users.buyer.list': '买家列表',
  'users.buyer.list.name': '名称',
  'users.buyer.list.company': '公司',
  'users.buyer.list.account_role': '账户类型',
  'users.buyer.list.create_time': '创建时间',
  'users.buyer.list.action': '操作',
}
